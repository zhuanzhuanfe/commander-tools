...
const babelPath = resolve('.babelrc.js');
let babelFun = '';

try {
  babelFun = require(babelPath)
} catch (error) {

}

const babelConfig = typeof babelFun === 'function' ? babelFun(false) : require(path.join(__dirname,'.babelrc.js'))(false)
